...
struct APIs {
    ...
    static func get(_ id: String, type: String, forceDomain: String?) -> String {
        ...
        case "iosBlackList":
            urlString = "\(domain)index.php/jsapi/\(id)?v=2"
        case "iosYellowCard":
    ...
    public static func getHTMLCode(_ from: String) -> String {
        ...
        for item in savedItems {
            ...
            if let audioFileUrl = item["audioFileUrl"] {
                audioDataString = " data-audio=\"\(audioFileUrl)\""
            } else {
                audioDataString = ""
            }
            let contentItem = "<div class=\"item-container one-row L6 M12 S6 P12 item-container-app no-image\" data-id=\"\(id)\" data-type=\"\(type)\"\(audioDataString)><div class=\"item-inner\"><h2 class=\"item-headline\"><a target=\"_blank\" href=\"\(link)\">\(item["headline"] ?? "")</a></h2><div class=\"item-lead\">\(lead)</div><div class=\"icon-right icon-save\"></div><div class=\"item-bottom\"></div></div></div>"
